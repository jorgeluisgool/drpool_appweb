                    ...
                    {currentRows.map((proyectoAlberca, index) => (
                        <tr
                            ...
                            onClick={() => {
                                ...
                                const alberca ={...proyectoAlberca};

                                const arrSedes = proyectoAlberca.proyectoSedes.map(sede => (
                                    sede.sede
                                ))
                                alberca.proyectoSedes = [...arrSedes];
                                    
                                setProyectoAlbercaSeleccionado(alberca);
                                setModalCrearEditarProyectos(true);
                                setClienteSelect(alberca.proyectoSedes[0].cliente)
                            }}

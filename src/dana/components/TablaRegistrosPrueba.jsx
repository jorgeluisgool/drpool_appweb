...
const registros = [
    {
        proyecto : 'AlbercaOlimpica-obregon',
        folio : '0001',
        estatus : 'Completado',
        fechacreacion : '01/07/23'
    },
    {
        proyecto : 'AlbercaOlimpica-obregon',
        folio : '0002',
        estatus : 'Asignado',
        fechacreacion : '01/08/23'
    },
    {
        proyecto : 'AlbercaOlimpica-obregon',
        folio : '0003',
        estatus : 'Asignado',
        fechacreacion : '01/09/23'
    },
    {
        proyecto : 'AlbercaOlimpica-obregon',
        folio : '0004',
...
export const TablaRegistrosPrueba = ({data, headers, onDelete, onEdit, selectedRows, isSelected, onSelectedRow, setModalAbrirCerrar, listaRegistros, setProyectoSeleccionado, setDataProyectoSeleccionado, usuariosSeleccionados}) => {
          ...
          >
            <td className="px-6">
              <div className="flex items-center">
                ...
                <div className="ml-8">
                  <div className="text-sm font-medium text-gray-900 cursor-pointer">{registro.proyecto}</div>
